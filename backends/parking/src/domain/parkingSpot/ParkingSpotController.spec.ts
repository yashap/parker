...
describe(ParkingSpotController.name, () => {
  ...
  let landlordParkingClient: ParkingClient
  let renterParkingClient: ParkingClient
  ...
  describe('Individual item endpoints', () => {
    ...
    beforeEach(async () => {
      ...
      parkingSpot = await landlordParkingClient.parkingSpots.create(parkingSpotPostBody)
    ...
    describe('getById', () => {
      it('landlord should be able to get own parking spot by id', async () => {
        expect(await landlordParkingClient.parkingSpots.get(parkingSpot.id)).toStrictEqual(parkingSpot)
      })

      it('renter should be able to get parking spot by id', async () => {
        expect(await renterParkingClient.parkingSpots.get(parkingSpot.id)).toStrictEqual(parkingSpot)
      })

      it('should verify that a parking spot does not exist', async () => {
        expect(await landlordParkingClient.parkingSpots.get(uuid())).toBeUndefined()
      })
      ...
      it('should work for a parking spot with time rules and time rule overrides', async () => {
        ...
        parkingSpot = await landlordParkingClient.parkingSpots.create(input)
        expect(await landlordParkingClient.parkingSpots.get(parkingSpot.id)).toStrictEqual(parkingSpot)
    ...
    describe('update', () => {
      it('landlord should be able to update a parking spot', async () => {
        ...
        expect(
          omit(await landlordParkingClient.parkingSpots.update(parkingSpot.id, update), ['updatedAt'])
        ).toStrictEqual({
      ...
      it('renter should not be able to update a parking spot', async () => {
        const update: UpdateParkingSpotRequest = { location: { longitude: 2, latitude: 3 } }
        await expect(renterParkingClient.parkingSpots.update(parkingSpot.id, update)).rejects.toThrow(ForbiddenError)
      ...
      it('should be able to replace time rules and time rule overrides', async () => {
        ...
        const parkingSpotWithUpdate1 = await landlordParkingClient.parkingSpots.update(parkingSpot.id, update1)
        expect(omit(parkingSpotWithUpdate1, ['updatedAt'])).toStrictEqual({
          ...omit(parkingSpot, ['updatedAt']),
          ...update1,
        })
        expect(await landlordParkingClient.parkingSpots.get(parkingSpot.id)).toStrictEqual(parkingSpotWithUpdate1)
        ...
        const parkingSpotWithUpdate2 = await landlordParkingClient.parkingSpots.update(parkingSpot.id, update2)
        expect(omit(parkingSpotWithUpdate2, ['updatedAt'])).toStrictEqual({
          ...omit(parkingSpot, ['updatedAt']),
          ...update2,
        })
        expect(await landlordParkingClient.parkingSpots.get(parkingSpot.id)).toStrictEqual(parkingSpotWithUpdate2)
      })
    })

    describe('delete', () => {
      it('landlord should be able to delete a parking spot', async () => {
        expect(await landlordParkingClient.parkingSpots.get(parkingSpot.id)).toBeDefined()
        await landlordParkingClient.parkingSpots.delete(parkingSpot.id)

        // And assert it's deleted
        expect(await landlordParkingClient.parkingSpots.get(parkingSpot.id)).toBeUndefined()
      })

      it('renter should not be able to delete a parking spot', async () => {
        expect(await renterParkingClient.parkingSpots.get(parkingSpot.id)).toBeDefined()
        await expect(renterParkingClient.parkingSpots.delete(parkingSpot.id)).rejects.toThrow(ForbiddenError)
  ...
  describe('List endpoints', () => {
    ...
    beforeEach(async () => {
      ...
      for (let idx = 0; idx < 20; idx++) {
        const parkingSpot = await landlordParkingClient.parkingSpots.create({
          address: '90210 Fancy Street',
        ...
        allSpots.push(required(await landlordParkingClient.parkingSpots.get(parkingSpot.id)))
      }
    })
    ...
    describe('listClosestToPoint', () => {
      it('landlord should be able to list the parking spots closest to a given point', async () => {
        ...
        const { data: foundSpots } = await landlordParkingClient.parkingSpots.listClosestToPoint({
      ...
      it('renter should be able to list the parking spots closest to a given point', async () => {
        ...
        // Then get those 5 spots, verify they're the 5 closest
        const { data: foundSpots } = await renterParkingClient.parkingSpots.listClosestToPoint({
          longitude: location.longitude,
          latitude: location.latitude,
          limit: 5,
        })
    ...
    describe('list', () => {
      it('paginates properly, in ascending order', async () => {
        const page1 = await landlordParkingClient.parkingSpots.listPage({
        ...
        const page2 = await landlordParkingClient.parkingSpots.listPage({
          ownerUserId: landlordUserId,
        ...
        const page3 = await landlordParkingClient.parkingSpots.listPage({
          ownerUserId: landlordUserId,
        ...
        const page4 = await landlordParkingClient.parkingSpots.listPage({
          ownerUserId: landlordUserId,
      ...
      it('allows going "backwards" using the previous cursor', async () => {
        ...
        const page1Again = await landlordParkingClient.parkingSpots.listPage({
          ownerUserId: landlordUserId,
      ...
      it('lists all parking spots', async () => {
        const spots = await landlordParkingClient.parkingSpots.listAllPages({
          ownerUserId: landlordUserId,
          orderBy: 'createdAt',
          orderDirection: OrderDirectionValues.asc,
          limit: 7,
